...
public class AvatarImageBehaviour extends CoordinatorLayout.Behavior<CarDekhoImageView> {
    ...
    public AvatarImageBehaviour(
            final Context context,
            final AttributeSet attrs) {

        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.AvatarImageBehaviour);
            finalXPosition = a.getDimension(R.styleable.AvatarImageBehaviour_finalXPosition, 0);
            finalYPosition = a.getDimension(R.styleable.AvatarImageBehaviour_finalYPosition, 0);
            finalHeight = a.getDimension(R.styleable.AvatarImageBehaviour_finalHeight, 0);
            finalToolbarHeight = a.getDimension(R.styleable.AvatarImageBehaviour_finalToolbarHeight, 0);
            a.recycle();
        }
    }
